...
import { Modal, Button, DatePicker, SelectPicker } from 'rsuite'
            ...
            <Modal backdrop="static" keyboard={false} open={open} onClose={handleClose}>
                ...
                <Modal.Footer>
                    ...
                    <div>
                        ...
                        <SelectPicker style={{ marginLeft: '3px' }} value={untilMode} onChange={(e) => setUntilMode(e as any)} searchable={false} data={[{ label: formatMessage({ id: 'update.date' }), value: 'date' }, { label: formatMessage({ id: 'update.next_update' }), value: 'nextUpdate' }]} />
                        {untilMode === 'date' && <DatePicker value={until} onChange={(e) => setUntil(e)} />} <Button onClick={hide} appearance="default">
