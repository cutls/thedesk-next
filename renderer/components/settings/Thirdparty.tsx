...
import { thirdparty, packages } from '../../thirdparty'
	...
	return (
		<Modal backdrop="static" keyboard={true} open={props.open} onClose={props.onClose}>
			...
			<Modal.Body>
				...
				<Heading as="h2" style={{ textAlign: 'center', marginTop: '15px' }}>TheDesk</Heading>
				<p style={{ textAlign: 'center', marginTop: '15px' }}>Version: {packages.version}({packages.codename})</p>
				<p style={{ textAlign: 'center' }}>© cutls 2024</p>
				<p style={{ textAlign: 'center' }}>Strongly powered by <Button startIcon={<Image src="https://fedistar.net/favicon/favicon.ico" alt="fedistar" width={20} height={20} />} onClick={() => open('https://fedistar.net/')}>Fedistar (© 2023 Akira Fukushima)</Button></p>
				<p style={{ textAlign: 'center' }}>TheDesk (including Fedistar) is licensed under GPL-3. <Button startIcon={<Icon as={BsGithub} />} onClick={() => open('https://github.com/cutls/thedesk-next')}>Source code</Button></p>
