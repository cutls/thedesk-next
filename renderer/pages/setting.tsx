        ...
        <div style={Object.assign({ backgroundColor: 'var(--rs-bg-well)' }, style)}>
            ...
            <Stack style={{ justifyContent: 'center', display: 'flex' }}>
                <Content style={{ width: 600, maxWidth: '100%', padding: 10, marginTop: 50, marginBottom: 50 }}>
                    ...
                    <NumberForm label={formatMessage({ id: 'settings.settings.timeline.max_length' })} hint={formatMessage({ id: 'settings.settings.timeline.max_length_hint' })} value={timelineConfig.max_length} onChange={(value) => updateTimeline('max_length', value)} min={10} max={1000} step={1} unit={formatMessage({ id: 'settings.settings.timeline.max_length_unit' })} />
